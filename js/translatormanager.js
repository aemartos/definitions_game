...
export default class TranslatorManager{
  ...
  update(){
    ...
    $("#finish_title").html(this.trans.t("la prueba ha terminado. puedes cerrar esta ventana.</br> acertaste <span class='right-words'></span> palabras de <span class='total-words'></span>, tu puntuación es: <span class='test-average'></span>."));
